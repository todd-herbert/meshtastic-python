...
class GeoChat(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_to", b"_to", "to", b"to"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_to", b"_to", "message", b"message", "to", b"to"]) -> None: ...
