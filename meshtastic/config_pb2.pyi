...
class Config(google.protobuf.message.Message):
    ...
    class PowerConfig(google.protobuf.message.Message):
        ...
        class _BatteryChemistry:
            ValueType = typing.NewType("ValueType", builtins.int)
            V: typing_extensions.TypeAlias = ValueType

        class _BatteryChemistryEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[Config.PowerConfig._BatteryChemistry.ValueType], builtins.type):
            DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
            UNSPECIFIED: Config.PowerConfig._BatteryChemistry.ValueType  # 0
            LI_ION: Config.PowerConfig._BatteryChemistry.ValueType  # 1
            LIFEPO4: Config.PowerConfig._BatteryChemistry.ValueType  # 2
            LTO: Config.PowerConfig._BatteryChemistry.ValueType  # 3
            NIMH: Config.PowerConfig._BatteryChemistry.ValueType  # 4
            ALKALINE: Config.PowerConfig._BatteryChemistry.ValueType  # 5
            LEAD_ACID: Config.PowerConfig._BatteryChemistry.ValueType  # 6

        class BatteryChemistry(_BatteryChemistry, metaclass=_BatteryChemistryEnumTypeWrapper):
            """
            Defines different battery types
            """

        UNSPECIFIED: Config.PowerConfig.BatteryChemistry.ValueType  # 0
        LI_ION: Config.PowerConfig.BatteryChemistry.ValueType  # 1
        LIFEPO4: Config.PowerConfig.BatteryChemistry.ValueType  # 2
        LTO: Config.PowerConfig.BatteryChemistry.ValueType  # 3
        NIMH: Config.PowerConfig.BatteryChemistry.ValueType  # 4
        ALKALINE: Config.PowerConfig.BatteryChemistry.ValueType  # 5
        LEAD_ACID: Config.PowerConfig.BatteryChemistry.ValueType  # 6
        ...
        BATTERY_CHEMISTRY_FIELD_NUMBER: builtins.int
        BATTERY_CELL_COUNT_FIELD_NUMBER: builtins.int
        ...
        """
        battery_chemistry: global___Config.PowerConfig.BatteryChemistry.ValueType
        battery_cell_count: builtins.int
        def __init__(
            self,
            *,
            is_power_saving: builtins.bool = ...,
        ...
        def ClearField(self, field_name: typing.Literal["adc_multiplier_override", b"adc_multiplier_override", "battery_cell_count", b"battery_cell_count", "battery_chemistry", b"battery_chemistry", "device_battery_ina_address", b"device_battery_ina_address", "is_power_saving", b"is_power_saving", "ls_secs", b"ls_secs", "min_wake_secs", b"min_wake_secs", "on_battery_shutdown_after_secs", b"on_battery_shutdown_after_secs", "sds_secs", b"sds_secs", "wait_bluetooth_secs", b"wait_bluetooth_secs"]) -> None: ...
