...
class LocalModuleConfig(google.protobuf.message.Message):
    ...
    @property
    def autoresponder(self) -> meshtastic.module_config_pb2.ModuleConfig.AutoresponderConfig:
        """
    ...
    def __init__(
        ...
        *,
        ...
        autoresponder: meshtastic.module_config_pb2.ModuleConfig.AutoresponderConfig | None = ...,
        version: builtins.int = ...,
    ) -> None: ...
